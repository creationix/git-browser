...
${CHROME}/manifest.json: manifest.json
	sed -e 's/chromeapp\/background\.js/background.js/' manifest.json > ${CHROME}/manifest.json

${CHROME}/background.js: chromeapp/background.js
	sed -e 's/chromeapp\/index\.html/index.html/' chromeapp/background.js > ${CHROME}/background.js

${CHROME}/index.html: chromeapp/index.html
	sed -e 's/\( *\).*bootstrap\.js.*/\1<script src="app.js"><\/script>/' chromeapp/index.html > ${CHROME}/index.html
